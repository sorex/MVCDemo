...
(function ($)
{
	...
	$.widget("ui.menubar", {
		...
		_create: function ()
		{
			...
			.addClass("ui-menubar ui-widget-content ui-helper-clearfix")
			.attr("role", "menubar");
		...
		_destroy: function ()
		{
			...
			.removeClass("ui-menubar ui-widget-content ui-helper-clearfix")
